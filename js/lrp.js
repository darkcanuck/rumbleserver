...
$(function () {
	...
	$.ajax({
	    ...
	    success: function(data){
	    	...
	    	$("#info").html("<img src='flags/" + bot.name.split(".")[0] + ".gif' style='float: left; margin-right: 10px'><h2> " + bot.name + "</h2>" +
	    	"Current ranking: <b>" + bot.rating+"</b><br />" +
	    	"Avg. Score: <b>" + (bot.APS * 100).toFixed(2) + "</b><br />" +
	    	"Battles: <b>" + bot.numBattles+"</b><br />" +
	    	"Last battle: <b>" + formatDate(lastBattle)+"</b><br />" +
	    	"Specialization index: <b>" + bot.specializationIndex.toFixed(2)+"</b><br />" +
	    	"Momentum: <b>" + bot.momentum.toFixed(2) + "</b><br /><br />");
	    	data_rank = [];
	    	//bot.data_pos = [];
	    	data_expected = [];
	    	var Sx=0;
